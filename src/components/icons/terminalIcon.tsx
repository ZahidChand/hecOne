...
const TerminalIconSVG: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg
    style={{ color: "white" }}
...
export const TerminalIcon = (props: React.ComponentProps<typeof Icon>) => (
  <Icon component={TerminalIconSVG} {...props} />
)
